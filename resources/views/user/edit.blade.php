                        ...
                        <form action="{{ Route('user.store') }}" method="POST" class="row g-3" role="form">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="txtNombre" placeholder="Nombre" class="form-control"
                                    id="txtNombre" value="{{session('nombre')}}" aria-describedby="inputGroupPrepend">
                            </div>

                            <div class="form-group mb-3">
                                <label for="txtUser" class="form-label"> Usuario </label>
                                <input type="text" name="txtUser" placeholder="Usuario" class="form-control"
                                    id="txtUser" value="{{session('usuario')}}" aria-describedby="inputGroupPrepend">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group bg-light">
                                    <input type="password" class="form-control" id="txtPassword"
                                        value="" name="txtPassword" placeholder="contraseña"
