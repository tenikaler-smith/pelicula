                    ...
                    <div class="card bg-light">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center m-auto">
                                <h4 class="text-uppercase text-center"> Editar Usuario </h4>
                            </div>
                            ...
                            <form class="form-horizontal" action="{{ Route('user.update') }}" method="POST" role="form">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" name="idUsuario" id="idUsuario" class="form-control" value="{{session("id_user")}}">
                                    ...
                                    <div class="form-group row">
                                        <label for="txtPassword2" class="col-sm-3 text-end control-label col-form-label">Repetir Contraseña</label>
                                        <div class="col-sm-9">
