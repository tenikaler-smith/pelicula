...
<div id="carouselId" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img src="{{asset("assets/back/img/xmen.jpg")}}" alt="First slide">
        ...
        <div class="carousel-item">
            <img src="{{asset("assets/back/img/fast and furios.png")}}" alt="Second slide">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
            <img src="{{asset("assets/back/img/aladin.jpg")}}" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
    ...
    @for ($i = 1; $i <= 4; $i++) <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Animi saepe, ea ratione quos iusto aspernatur quam rem distinctio quisquam possimus non molestiae est libero harum ab assumenda! Corrupti, qui assumenda!
                </p>
